...
const Footer = () => {
  return (
    <section class="relative overflow-hidden py-8 text-white">
      <div class="container relative z-10 mx-auto px-4">
        <div class="-m-8 flex flex-wrap items-center justify-between">
          <div class="w-auto p-8">
            <span class="ml-4 text-lg font-bold">Abhishek</span>
          </div>
          <div class="w-auto p-8">
            <ul class="-m-5 flex flex-wrap items-center">
              <li class="p-5">
                <a class="font-medium text-slate-300 hover:text-white" href="#">
                  Privacy Policy
                </a>
              </li>
              <li class="p-5">
          ...
          <div class="w-auto p-8">
            <div class="-m-1.5 flex flex-wrap">
              <div class="w-auto p-1.5">
                <a href="https://github.com/AbhishekKumar2002" target="_blank">
                  <div class="flex h-8 w-8 items-center justify-center rounded-full border border-slate-300 hover:border-white">
                    <svg
              ...
              <div class="w-auto p-1.5">
                <a href="https://www.linkedin.com/in/abhishek-kumar-202362229/" target="_blank">
                  <div class="flex h-8 w-8 items-center justify-center rounded-full border border-slate-300 hover:border-white">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="16"
              ...
              <div class="w-auto p-1.5">
                <a
                  target="_blank"
                  href="https://www.instagram.com/ravikumar_._._/"
                >
                  <div class="flex h-8 w-8 items-center justify-center rounded-full border border-slate-300 hover:border-white">
                    <svg
                      width="16"

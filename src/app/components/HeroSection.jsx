      ...
      <div className="grid grid-cols-1 sm:grid-cols-12">
        <div className="col-span-7 place-self-center text-center sm:text-left">
          <h1 className="text-white mb-4 text-4xl sm:text-5xl lg:text-6xl font-extrabold">
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-cyan-700">
              Hello, I'm {""}
            </span>
            <br />
            <TypeAnimation
          ...
          <div>
            ...
            >
              <span className="block bg-[#121212] hover-bg-slate-800 rounded-full px-5 py-2">
                {" "}
                <Link href='https://firebasestorage.googleapis.com/v0/b/port-1707b.appspot.com/o/Software_Engineer_Resume__5_%20(3).pdf?alt=media&token=9a375a80-3de0-40b2-af1b-49367583a90d' target="_black">Download CV</Link>
